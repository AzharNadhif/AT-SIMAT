...
describe('AT-CORE-0039', () => {
    ...
    describe('AT-CORE-0039-01-02', async () => {
        it('Create Surat Jalan - MTS', async () => {
            ...
            await OutBagPage.createbag('REGULAR', generatedConnoteNumber, "SUX02", soft); 
            ...
            await OutSJPage.createSJ(generatedConnoteNumber, "TRUCK(B 1234 TEST)", "KURIR ANTER (DPKS230)", soft);
